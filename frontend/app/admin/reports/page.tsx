const PLANNED = [
  "Signup, payment, and squad-lock funnels over time",
  "Group-level (Science/Arts/Commerce) growth breakdown",
  "Mentor supply vs. eligible-squad demand",
];
    ...
    <main className="flex-1 px-4 py-12 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-3xl">
        ...
        <p className="mt-2 max-w-lg text-sm text-text-dim">
          Platform-wide trends across students, mentors, payments, and squads.
        </p>
